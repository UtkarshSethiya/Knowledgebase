                ...
                <div className="col-md-7 step   ">
                   ...
                   <div id='plancont'><h6   id='plan'></h6> <Link id='medium' to='/calculator_medium' className='  btn btn-outline-primary btn2'>Continue</Link></div>
                    ...
                    <div className=" row step ">
                            ...
                            <p>Define the volume of attendees per month for all your events <Tippy className='tippy' content="For Medium Plan Attendes upto 500 are free beyond that, every additional 1-25 users $20 wil be charged "><button className='poper'><i class="bi bi-info-circle-fill"></i></button></Tippy>  </p>
  ...
  <span class="visually-hidden">Loading...</span>
                ...
                <div id='qotation' className='row  invoice2 '>
                 ...
                 <div className='col-7  ' >
                  ...
                  <p >Great ,You are eligible for Medium Plan !<br></br><div className='row'><span className='lastline col-8'>***Quotation Validity is for 5 days from the time of Quotation generated date  Please  get back to us at accounts@bizconnectevents.com for any queries 
