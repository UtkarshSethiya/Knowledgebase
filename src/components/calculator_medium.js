...
import whitelabelimage from './images/whitelabelimage.jpeg'
...
<div className='col-6   '  > </div>
                ...
                <div className="row step  ">
                   ...
                   <div id='plancont'><h6   id='plan'></h6> <Link id='medium' to='/calculator_medium' className='  btn btn-outline-primary btn2'>Continue</Link></div>
                    ...
                    <div className="  row step ">
                            ...
                            <p>Define the volume of attendees per month for all your events <a title='For Medium Plan Attendes upto 500 are free beyond that, every additional 1-25 users $18 wil be charged '><i class="bi bi-info-circle-fill"></i></a> </p>
                        <span className='col-1 zero'>500</span>
                        <div className='col-5'><input type="range" min="500" max="1000" step="25" value={attend} onkeydown="return false" onChange={attendenumber}  class="form-range  " id="customRange1"/></div>
                        <span className='col-1'>1000</span>
                        <div className='col-2'></div>
                        <div className='col-2'>
                        <input className='value' id='attend'  type='number'min="500" max="1000" step="25" value={attend} onkeydown="return false" onChange={attendenumber} ></input><pre></pre>
                    ...
                    <div className='col-12'>
                     ...
                     <p>Extra Booth($100/booth) <a title='For medium plan Booths upto 5 are free above 5 you will be charged '><i class="bi bi-info-circle-fill"></i></a></p>
                       <div className='row'>
                      
                        <div className='col-1  zero'>5</div>
                        <div className='col-5'><input type="range" min="5" max="100" step="1" value={exhibitor} onChange={exhibitornumber}  class="form-range  " id="customRange1"/></div>
                        <span className='col-1'>100</span>
                        <div className='col-2'></div>
                        <div className='col-2'>
                        <input id='exhibitor'  type='number' className='value'  min="5" max="100" step="1" value={exhibitor} onChange={exhibitornumber} ></input><pre></pre>
                        <h6>Cost: ${exhibitorcost}</h6>
                    </div>
                       <pre></pre>
                        
                        <p>Buy Custom Hall Template ($100/hall) <a title='For medium plan Halls upto 5 are free above 5 you will be charged '><i class="bi bi-info-circle-fill"></i></a> </p>
                        <span className='col-1 zero'>5</span>
                        <div className='col-5'><input type="range" value={customhall} min="5" max="50" step="1" onChange={customhallnumber}  class="form-range  " id="customRange1"/></div>
                        <span className='col-1'>50</span>
                        <div className='col-2'></div>
                        <div className='col-2'>
                        <input id='customhall'  type='number' className='value' min="5" max="50" step="1" value={customhall}  onChange={customhallnumber} ></input><pre></pre>
                    ...
                    <pre></pre><pre></pre>
                      ...
                      <div className='col-3'><input class="form-check-input" type="checkbox" value="" id="flexCheckChecked" onChange={whitelabelnumber}></input><pre></pre>  <h6>Cost: ${ whitelabelcost}</h6>
                        ...
                        <h6>Cost: ${auditoriumcost}</h6></div>
                            ...
                            <p>Games with Leaderboard ($50/game) <a title='For medium plan games upto 2 are free above 2 you will be charged '><i class="bi bi-info-circle-fill"></i></a> </p>
                            
                            <span className='col-1 zero'>2</span>
                        <div className='col-5'><input type="range" value={games } min="2" max="50" step="1" onChange={gamesnumber}  class="form-range  " id="customRange1"/></div>
                        <span className='col-1'>50</span>
                        <div className='col-2'></div>
                        <div className='col-2'>
                        <input className='value' id='game'  type='number' value={games } min="2" max="50" step="1" onChange={gamesnumber} ></input><pre></pre>
    ...
    Post 1st Event - Per hr $ 75'><i class="bi bi-info-circle-fill"></i></a>  </p>
                        ...
                        <h6>Cost: ${hourcost}</h6></div>
                             ...
                             <h2 className='total'><pre></pre>Total:-${total}  </h2> <h5>Great,You are eligible for Medium Plan!</h5> 
