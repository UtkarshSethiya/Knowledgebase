                ...
                <div className="row step  ">
                   ...
                   <div id='plancont'><h6   id='plan'></h6> <Link id='medium' to='/calculator_medium' className='  btn btn-outline-primary btn2'>Continue</Link></div>
                    ...
                    <div className="  row step ">
                            ...
                            <p>Define the volume of attendees per month for all your events <a title='For Custom Plan Attendes upto 1000 are free beyond that, every additional 1-25 users $10 wil be charged '><i class="bi bi-info-circle-fill"></i></a> </p>
                    ...
                    <div className='col-12'>
                     ...
                     <p>Extra Booth($100/booth) <a title='For Custom plan you will be charged $100 per booth'><i class="bi bi-info-circle-fill"></i></a></p>
                       <div className='row'>
                       ...
                       <pre></pre>
                        ...
                        <p>Buy Custom Hall Template ($100/hall) <a title='For Custom plan you will be charged $100 per hall'><i class="bi bi-info-circle-fill"></i></a> </p>
                    ...
                    <pre></pre><pre></pre>
                      ...
                      <div className='col-3'><input class="form-check-input" type="checkbox" value="" id="flexCheckChecked" onChange={whitelabelnumber}></input><pre></pre>  <h6>Cost: ${ whitelabelcost}</h6>
                        ...
                        <h6>Cost: ${auditoriumcost}</h6></div>
                            ...
                            <p>Games with Leaderboard ($50/game) <a title='For Custom Plan upto 3 games are Free beyond that you will be charged for extra games'><i class="bi bi-info-circle-fill"></i></a> </p>
                            
                            <span className='col-1 zero'>3</span>
                        <div className='col-5'><input type="range" value={games } min="3" max="50" step="1" onChange={gamesnumber}  class="form-range  " id="customRange1"/></div>
                        <span className='col-1'>50</span>
                        <div className='col-2'></div>
                        <div className='col-2'>
                        <input className='value' id='game' type='number' value={games } min="3" max="50" step="1" onChange={gamesnumber} ></input><pre></pre>
