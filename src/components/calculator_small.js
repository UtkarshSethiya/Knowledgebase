                   ...
                   <div className='col-md-7'>
                    ...
                    <pre></pre>
                       ...
                       <div className='col   '><pre></pre><pre></pre>
                           <h5 >White Label ($250/month) <Tippy className='tippy' content="Depending on no of events white label will be charged"><button className='poper'><i class="bi bi-info-circle-fill"></i></button></Tippy> </h5>
                           <p className='col'>
